...
export default function Banner(): React.JSX.Element {
  const texts = ["IT Student", "Web Developer", "Tech Enthusiast"];
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col lg:flex-row items-center ">
                ...
                <div className="relative inline-block ">
                  ...
                  <div className="relative">
                    <p className="text-white text-lg whitespace-nowrap">
                      Hello! I Am{" "}
                      <span className="text-purple-400">Kausal Upadhayaya</span>
                    </p>
                  </div>
          ...
          <div className="flex-1 space-y-6 text-center lg:text-left">
            ...
            <div className="">
              <p className="text-2xl"> An IT Student who </p>
        ...
        <div className="space-y-3 pt-15 text-center lg:text-left">
          ...
          <p className="text-lg lg:text-xl text-white/90 tracking-wide flex flex-wrap items-center justify-center lg:justify-start gap-2">
            <span>Third year bachelor in IT student</span>
          </p>
          <p className="text-lg text-white/80 max-w-2xl mt-15 mx-auto lg:mx-0">
            I am a dedicated IT student with a passion for web development and creating user-friendly applications.
